...
def travel(treenode : sparta.TreeNode, level : int) : 
    for subnode in treenode.getAllChildren() : 
        ...
        if(subnode.getName() == "ports") :
            ...
            ports : PortSet = treenode.__getattribute__(subnode.getName())
            ...
            params : ParameterSet = treenode.__getattribute__(subnode.getName())
...
print(rtn.params.my_device_param.getValueAsString())
rtn.params.my_device_param.set(False)
print(rtn.params.my_device_param.getValueAsString())
