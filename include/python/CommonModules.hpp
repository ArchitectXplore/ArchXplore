    ...
    namespace python
    {
        ...
        void bindCommonModules(pybind11::module_ &parent)
        {
            ...
            pybind11::class_<archXplore::system::Process>(parent, "Process")
                ...
                .def_readwrite("boot_hart", &archXplore::system::Process::boot_hart, "Boot hart ID")
            ...
            pybind11::class_<ClockedObject, PyClockedObject, sparta::TreeNode>(parent, "ClockedObject")
                ...
                .def("setClockDomain", &ClockedObject::setClockDomain, pybind11::return_value_policy::reference, "Set the clock domain of the object")
                .def("setClockFrequency", &ClockedObject::setClockFrequency, pybind11::return_value_policy::reference, "Set the clock frequency of the object")
            .def("setRank", &ClockedObject::setRank, pybind11::return_value_policy::reference, "Set the rank of the object")
            ...
            pybind11::class_<archXplore::system::AbstractSystem, sparta::RootTreeNode>(system, "__AbstractSystem", pybind11::dynamic_attr())
                .def("run", &archXplore::system::AbstractSystem::run, pybind11::arg("tick") = sparta::Scheduler::INDEFINITE, "Run the system for a given number of ticks (default: indefinite)")
                .def("build", &archXplore::system::AbstractSystem::build, "Build the system")
                .def("newProcess", &archXplore::system::AbstractSystem::newProcess, pybind11::return_value_policy::reference, "Create a new process")
                .def_readwrite("interval", &archXplore::system::AbstractSystem::m_multithread_interval, "Multithreading interval (in ticks)");
            // Bind QemuSystem
