...
#define REGISTER_SPARTA_UNIT(UnitClass, ParamClass)                                                                            \
    ...
    public:                                                                                                                    \
        UnitClass##Component(TreeNode *parent, const std::string &name)                                                        \
            : ResourceTreeNode(parent, name, "Resource Tree Node of" + name, new UnitClass##Factory){};                        \
        UnitClass##Component(const std::string &name)                                                                          \
            : ResourceTreeNode(name, "Resource Tree Node of" + name, new UnitClass##Factory){};                                \
        ~UnitClass##Component(){};                                                                                             \
    };                                                                                                                         \
